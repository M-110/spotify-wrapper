...
def get_new_credentials() -> dict:
    if is_missing_credentials():
        ...
        get_authorization_code(code_challenge)
...
def generate_code_verifier_and_challenge() -> Tuple[bytes, str]:
...
def get_authorization_code(code_challenge: str):
